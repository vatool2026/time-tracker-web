    ...
    <>
      ...
      {success && (
        <div className="glass" style={{
          ...
          <CheckCircle size={18} />
          <span>Passwort erfolgreich aktualisiert. Sie werden weitergeleitet...</span>
        </div>
      )}
    ...
    <main className="container flex-center" style={{ minHeight: '100vh', flexDirection: 'column', padding: '1rem', position: 'relative' }}>
      ...
      <div className="glass glass-card" style={{ width: '100%', maxWidth: '440px', padding: '2.5rem', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 className="text-gradient" style={{ fontSize: '2.25rem', marginBottom: '0.5rem' }}>Neues Passwort</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Bitte vergeben Sie ein neues Passwort für Ihr Konto.</p>
        </div>
